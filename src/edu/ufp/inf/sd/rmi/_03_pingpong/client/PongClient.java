...
public class PongClient {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 2) {
            System.err.println("usage: java [options] edu.ufp.sd.inf.rmi._03_ping.server.HelloWorldClient <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
    ...
    private Remote lookupService() {
        try {
            ...
            if (registry != null) {
                ...
                pongRI = (PongRI) registry.lookup(serviceUrl);
            } else {
    ...
    private void playService() {
        try {
            ...
            this.pongRI.ping(new Ball(1), pongRI);
