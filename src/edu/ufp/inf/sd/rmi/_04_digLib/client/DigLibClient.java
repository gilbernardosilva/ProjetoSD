...
public class DigLibClient {
     ...
     */
    private DigLibFactoryRI helloWorldRI;
    ...
    private Remote lookupService() {
        try {
            ...
            if (registry != null) {
                ...
                helloWorldRI = (DigLibFactoryRI) registry.lookup(serviceUrl);
            } else {
    ...
    private void playService() {
        ...
        try {
            this.sessionRI = this.helloWorldRI.login("guest","ufp");
            this.sessionRI.search("Distributed Systems: principles and paradigms","Tanenbaum");
        } catch (RemoteException e) {
            e.printStackTrace();
        }
