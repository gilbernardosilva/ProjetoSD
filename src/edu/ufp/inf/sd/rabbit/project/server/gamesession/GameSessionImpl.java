package edu.ufp.inf.sd.rabbit.project.server.gamesession;
...
public class GameSessionImpl extends UnicastRemoteObject implements edu.ufp.inf.sd.rmi.project.server.gamesession.GameSessionRI {
