...
@Set WORKDRIVE=C
@Set JDK=%WORKDRIVE%:\\Users\\olive\\.jdks\\corretto-1.8.0_362
...
@set JAVAPROJ=C:\Users\olive\OneDrive\Documentos\GitHub\ProjetoSD
@Set PACKAGE=project
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rabbit
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rabbit
...
@Set PRODUCER_CLASS_PREFIX=ProjectServer
@Set OBSERVER_CLASS_PREFIX=ClientImpl
...
@REM SERVICE_URL=rmi://%REGISTRY_HOST%:%REGISTRY_PORT%/%SERVICE_NAME%
...
@set CLASSPATH=.;%JAVAPROG_CLASSES_FOLDER%;C:\Users\olive\OneDrive\Documentos\GitHub\ProjetoSD\lib\*;
