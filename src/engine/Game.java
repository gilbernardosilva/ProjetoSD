...
public class Game extends JFrame {
    ...
    public Game(GameFactoryRI stub, GameSessionRI sessionRI, ObserverImpl observer) throws RemoteException, InterruptedException {
        super(name);
        ...
        this.session = sessionRI;
        String mapName;
        mapName = this.observer.getLobby().getMapname().toString();
        ...
        gui.CharacterSelection(mapName, this.observer);
        save.LoadSettings();
        GameLoop();
    }
